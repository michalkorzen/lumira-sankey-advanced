define("sap_viz_ext_sankeyadvanced-src/js/module", ["sap_viz_ext_sankeyadvanced-src/js/render","sap_viz_ext_sankeyadvanced-src/js/dataMapping"], function(render, processData) {
