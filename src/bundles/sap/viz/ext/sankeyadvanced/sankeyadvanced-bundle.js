define("sankeyadvanced-bundle", ["sap_viz_ext_sankeyadvanced-src/js/flow", "css!sap_viz_ext_sankeyadvanced-src/style/default.css"],
			...
			"components": [{
				...
				"customProperties": {
					...
					"resources": [{
						...
						"path": "./sap_viz_ext_sankeyadvanced-src/resources/templates"
					}]
				}
			}]
		});
